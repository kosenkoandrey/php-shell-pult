...
<body data-ma-header="teal">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('changed.bs.select', '.product-list', function(e) {
                $('#inv-prod-amount-' + $(this).data('counter'))
