                    ...
                    $.ajax({
                        ...
                        success: function(scheme) {
                            ...
                            $.each(scheme.conditions, function() {
                                ...
                                this.style = $.evalJSON(this.style);
                                this.url = (scheme.user_count['conditions:'+this.id] == undefined ? '' : scheme.user_count['conditions:'+this.id].url);
                                this.user_count = (scheme.user_count['conditions:'+this.id] == undefined ? 0 : scheme.user_count['conditions:'+this.id].count);
                            ...
                            $.each(scheme.timeouts, function() {
                                this.child_object = this.child_object ? this.child_object.split(':') : [],
                                this.style = $.evalJSON(this.style);
                                this.url = (scheme.user_count['timeouts:'+this.id] == undefined ? '' : scheme.user_count['timeouts:'+this.id].url);
                                this.user_count = (scheme.user_count['timeouts:'+this.id] == undefined ? 0 : scheme.user_count['timeouts:'+this.id].count);
                            ...
                            case 'action':
                                switch (TunnelEditor.Objects.Actions[id].action) {
                                    ...
                                    case 'subscribe':
                                        ...
                                        .append(
                                            ...
                                            .append(
                                                ...
                                                .append(
                                                    ...
                                                    .val(TunnelEditor.Objects.Actions[id].settings.tunnel_obj_type)
                                                )
                                            )
                                        )
                                        .append(
                                            ...
                                            .append(
                                                ...
                                                .append(
                                                    ...
                                                    .val(TunnelEditor.Objects.Actions[id].settings.tunnel_obj_id)
                                                )
                                            )
                                        )
                                        .append(
                                        ...
                                        .on('submit', function(e) {
                                            if ($('#tunnel_id').val()) {
                                                TunnelEditor.Objects.Actions[id].settings['tunnel_id'] = parseInt($('#tunnel_id').val());
                                            } else {
                                                delete TunnelEditor.Objects.Actions[id].settings['tunnel_id'];
                                            }
                                            
                                            if ($('#in_process_1').val()) {
                                                TunnelEditor.Objects.Actions[id].settings.tunnel_obj_type = $('#in_process_1').val();
                                            } else {
                                                delete TunnelEditor.Objects.Actions[id].settings.tunnel_obj_type;
                                            }
                                            
                                            if ($('#in_process_2').val()) {
                                                TunnelEditor.Objects.Actions[id].settings.tunnel_obj_id = parseInt($('#in_process_2').val());
                                            } else {
                                                delete TunnelEditor.Objects.Actions[id].settings.tunnel_obj_id;
                                            }
                                            
                                            TunnelEditor.Objects.Actions[id].settings.tunnel_timeout = 0;
                                        ...
                                        .append(
                                            ...
                                            .on('click', function() {
                                                ...
                                                .append(
                                                    ...
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'tunnel_id_' + random_subscribe_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .append('Туннель')
                                                    )
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<input/>', {
                                                                type: 'hidden',
                                                                class: 'form-control',
                                                                id: 'tunnel_id_' + random_subscribe_count
                                                            })
                                                        )
                                                    )
                                                )
                                        ...
                                        .on('submit', function(e) {
                                            ...
                                            for (var i = 0; i <= random_subscribe_count; i++) {
                                                if ($('#object-processes-list-settings-' + i).length) {
                                                    process_object.push({
                                                        'tunnel_id': $('#tunnel_id_' + i).val(),
                                                        'tunnel_obj_type': $('#in_process_1_' + i).val(),
                                                        'tunnel_obj_id': $('#in_process_2_' + i).val(),
                                                        'tunnel_timeout': 0,
