<?php
$user_menu = (isset($data['user_menu']) ? $data['user_menu'] : true);
?>
<!--
...
<div class="card" style="margin-bottom: 1px; margin-top: 30px; padding: 40px 30px;">
    <a href="<?= APP::Module('Routing')->root ?>users/profile" target="_blank" style="border: 0"><img src="<?= APP::Module('Routing')->root ?>public/ui/img/logo.png" style="width: 500px;"></a>
    <?php if($user_menu){ ?>
        <ul class="pull-right h-menu">
            <li class="dropdown hm-profile">
                <?
