<? 
function getUrl($event, $method, $filter, $date_from, $date_to, $units_from, $units_to){
    $filter['rules'][] = [
        'method' => $method,
        'settings' => [
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-padding">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <? foreach (APP::Module('Analytics')->config['rfm_mail']['units'] as $unit_id => $unit_range) { ?>
                                                <tr>
                                                    <td class="unit_id"><?= $unit_id ?></td>
                                                    <? foreach ($data['table1'] as $date_id => $date_range) {
                                                        if (isset($data['report'][$unit_id][$date_id])) {
                                                            $url = getUrl($data['event'], $data['method'], $data['filter'], date('d-m-Y H:i:s', $date_range[0]), date('d-m-Y H:i:s', $date_range[1]),$unit_range[0], $unit_range[1]);
                                                    ?>
                                                            <td class="details">
                                                    ...
                                                    <? $url = getUrl($data['event'], $data['method'], $data['filter'], 0, $data['dates_from'],$unit_range[0], $unit_range[1]); ?>
                                                    <td class="warning total"><a href="<?= $url; ?>" target="_blank"><span  class="clients" ><?= $data['totals']['units'][$unit_id]; ?></span></a></td>
                                                    <td><?= ($data['totals']['summary'] ? round((int) $data['totals']['units'][$unit_id] / ($data['totals']['summary'] / 100), 2) : round((int) $data['totals']['units'][$unit_id],2)); ?>%</td>
                                                </tr>
                                            <? } ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php foreach ($data['table1'] as $date_id => $date_range){
                                                    $url = getUrl($data['event'], $data['method'], $data['filter'], date('d-m-Y H:i:s', $date_range[0]), date('d-m-Y H:i:s', $date_range[1]),1, 9999); 
                                                ?>
                                                ...
                                                <?php } ?>
                                                <?
                                                    $url = getUrl($data['event'], $data['method'], $data['filter'], 0, $data['dates_from'],1, 9999); 
                                                ?>
                                            ...
                                            <tr>
                                                <td>Percentage</td>
                                                <? foreach ($data['table1'] as $date_id => $date_range) echo '<td>' . ($data['totals']['summary'] ? round((int) $data['totals']['dates'][$date_id] / ($data['totals']['summary'] / 100), 2) : round((int) $data['totals']['dates'][$date_id],2)) . '%</td>'; ?>
                                                <td>100%</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            ...
                                            foreach (APP::Module('Analytics')->config['rfm_mail']['units'] as $unit_id => $unit_range) {
                                                ...
                                                <tr>
                                                    ...
                                                    $url = getUrl($data['event'], $data['method'], $data['filter'], 0, $data['dates_two_from'],$unit_range[0], $unit_range[1]);
                                                    $totals2 = ($data['totals2']['summary'] ? round((int) $data['totals2']['units'][$unit_id] / ($data['totals2']['summary'] / 100), 2) : round((int) $data['totals2']['units'][$unit_id],2));
                                                    $totals = ($data['totals']['summary'] ? round((int) $data['totals']['units'][$unit_id] / ($data['totals']['summary'] / 100), 2) : round((int) $data['totals']['units'][$unit_id],2));
                                                    ?>
                                                    ...
                                                    <td><?= $totals2; ?>%<sup style="margin-left: 5px;"><?php if(round($totals2 - $totals,2) > 0){ echo '<i class="zmdi zmdi-caret-up zmdi-hc-fw" style="font-size:14px;color: rgb(47, 151, 4)"></i> '; } elseif(round($totals2 - $totals,2) < 0) { echo '<i class="zmdi zmdi-caret-down zmdi-hc-fw" style="font-size:14px;color: rgb(151, 11, 4)"></i> '; } echo abs(round($totals2 - $totals,2)); ?>%</sup></td>
                                                </tr>
                                                <?
                                            }
                                            ?>
                                            <tr>
                                                ...
                                                <?php } 
                                                    $url = getUrl($data['event'], $data['method'], $data['filter'], 0, $data['dates_two_from'],1, 9999); 
                                                ?>
                                            ...
                                            <tr>
                                                <td>Percentage</td>
                                                <? foreach ($data['table2'] as $date_id => $date_range){ 
                                                    $totals2 = ($data['totals2']['summary'] ? round((int) $data['totals2']['dates'][$date_id] / ($data['totals2']['summary'] / 100), 2) : round((int) $data['totals2']['dates'][$date_id],2));
                                                    $totals = ($data['totals']['summary'] ? round((int) $data['totals']['dates'][$date_id] / ($data['totals']['summary'] / 100), 2) : round((int) $data['totals']['dates'][$date_id],2));
                                                    
                                                    ?>
                                                    <td>
                                                        <?php echo ($data['totals2']['summary'] ? round((int) $data['totals2']['dates'][$date_id] / ($data['totals2']['summary'] / 100), 2) : round((int) $data['totals2']['dates'][$date_id],2)). '%'; ?>
                                                        <sup style="margin-left: 5px;">
                                                            <?php if(round($totals2 - $totals,2) > 0){ echo '<i class="zmdi zmdi-caret-up zmdi-hc-fw" style="font-size:14px;color: rgb(47, 151, 4)"></i> '; } elseif(round($totals2 - $totals,2) < 0) { echo '<i class="zmdi zmdi-caret-down zmdi-hc-fw" style="font-size:14px;color: rgb(151, 11, 4)"></i> '; } echo abs(round($totals2 - $totals,2)); ?>%
                                                        </sup>
                                                    </td>
                                                <?php } ?>
                                                <td>100%</td>
