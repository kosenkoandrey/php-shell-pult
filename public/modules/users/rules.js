    ...
    var methods = {
        ...
        getRulesListByLogic: function(logic) {
            return [
                ...
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="mail_open_time" href="javascript:void(0)">Letter open time</a></li>',
                ...
                case 'product_buy':
                    $('.trigger_settings', $trigger_rule_item).append([
                        '<table>',
                            ...
                            '<tr>',
                                '<td style="width: 200px">',
                                    '<input data-id="product" class="form-control m-l-5" type="text" placeholder="product id">',
                                '</td>',
                            '</tr>',
                        '</table>'
                    ].join(''));
